      ...
      <div class="about-me">
        <div class="programming-trigger">
          ...
          <div class="text-box">
            ...
            <p>
              なにもわからない状態から始めましたが、なんとか簡単なサイトやアプリを作ることができました。
            </p>
            <p>
          ...
          <div class="text-box">
            <p>
              自分のアイデアをPC1台で0から形にできるところに魅力を感じました。
            </p>
            <p> 
            ...
            <p>
              その反面でつまずくことも沢山ありますが、解決できた時はとても達成感があり、やりがいも感じました。
            </p>
          </div>
          <h3>3. 汎用性が高い</h3>
          <div class="text-box">
            <p>
              ある会社だけのスキルではなく、汎用性のあるスキルであると思ったからです。
            </p>
            <p>
              プログラミングスキルは、今後も数多くの場所で必要とされていくと思います。
              需要が増えていく中で、自分もスキルを身に着けて、
              誰かの役にたてたらいいなと思い、始めてみました。
            </p>
            <p>
              汎用性の高いスキルではありますが、挫折率がとても高いと言われています。
              それを見た時、チャンスだと思いましたし、挑戦してみたいなという気持ちになりました。
            </p>
          </div>
        </div>
        ...
        <div class="hobby">
          ...
          <div class="text-box">
            <p>
              初めは、スキーをしていたのですが、スノーボードでいろいろな技をしたり、滑ったりしているのを見て、楽しそうと思い始めました。
            </p>
            <p>
              実際に滑ってる人や動画などを見て、今では滑れるようになりました！
              自分が実際にどのような動きをしているかがわからないので、動画を撮ってもらい、それを見て改善していけたらもっと良くなるのではないかと考えています。
            </p>
            <p>
              初めていった日に怪我をしてしまいましたが、現在も楽しく続けています！
            </p>
            <p>
              また現在は、トリックにも挑戦しています！
            </p>
